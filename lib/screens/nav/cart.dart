      ...
      return Obx(() => Scaffold(
            ...
            bottomNavigationBar: Card(
              ...
              child: Container(
                ...
                //     left: Dimesion.radius5,
                //     right: Dimesion.radius5,
                //     top: Dimesion.radius5),
                decoration: BoxDecoration(
                  color: AppColor.white,
                  borderRadius: BorderRadius.only(
                    topLeft: Radius.circular(Dimesion.radius5),
                    topRight: Radius.circular(Dimesion.radius5),
                  ),
                ),
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              "${DataConstant.priceFormat.format(builder.totalAmt.value)} Ks",
                              style: Theme.of(context)
                                  .textTheme
                                  .titleSmall!
                                  .copyWith(
                                  ...
                                  children: [
                                    InkWell(
                                      ...
                                      child: Image.asset(
                                        ...
                                        width: Dimesion.iconSize16,
                                        height: Dimesion.iconSize16,
                                      ),
                                    ),
