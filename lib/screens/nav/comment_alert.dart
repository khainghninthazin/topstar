...
class CommentAlertWidget extends StatefulWidget {
  ...
  const CommentAlertWidget({super.key, required this.postData, required this.controller, required this.authController});
              ...
              slivers: [
                SliverList(
                    delegate: SliverChildListDelegate([
                      ...
                      if(widget.controller.postData.value.comments!.length!=0)
                        Container(
                                                    ...
                                                    children: [
                                                      ...
                                                      Flexible(child: Container(
                                                        ...
                                                        child: Column(
                                                          ...
                                                          children: [
                                                            Text(widget.controller.postData.value.comments![index].replies![i].poster.toString(),style: TextStyle(color: Colors.black,fontSize: Dimesion.font12,fontWeight: FontWeight.normal)),
                                                            Text(widget.controller.postData.value.comments![index].replies![i].body.toString(),style: TextStyle(color: Colors.black,fontSize: Dimesion.font12-3,fontWeight: FontWeight.normal))
                                                          ],
                                                        ),
                                                      ))
                                                    ],
