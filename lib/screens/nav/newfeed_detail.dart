...
import 'package:top_star/core/constants/api_route_constants.dart';
              ...
              slivers: [
                SliverList(
                    ...
                    Get.back();
                            ...
                            Gap(Dimesion.width10),
                            Text(widget.controller.postData.value.description.toString(),style: TextStyle(color: Colors.black,fontSize: Dimesion.font14,fontWeight: FontWeight.normal),),
                              ...
                              ListView.builder(
                                  ...
                                  itemBuilder: (BuildContext context, int index){
                                    return GestureDetector(
                                      onTap: (){
                                        Get.toNamed(RouteHelper.viewImage,arguments: ViewImageScreen(imgUrl: widget.controller.postData.value.images![index].path.toString()));
                                      },
                                      child: Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Gap(Dimesion.height5),
                                            Text(widget.controller.postData.value.images![index].description.toString(),style: TextStyle(color: AppColor.black,fontSize: Dimesion.font14,fontWeight: FontWeight.bold),),
                                            Gap(Dimesion.height5),
