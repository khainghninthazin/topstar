...
import 'package:top_star/core/app_widgets/search_page_view_view.dart';
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          //   ),
          //   child: Padding(
          //     padding:  EdgeInsets.only(left: Dimesion.width10, right: Dimesion.width20, top: Dimesion.height40+10),
          //     child: Row(
          //       children: [
          //         IconButton(
          //             onPressed: () {
          ...
          //             height: 40,
          //             width: MediaQuery.of(context).size.width,
          //             padding:  EdgeInsets.only(top: Dimesion.height10, bottom: Dimesion.height10, left: Dimesion.width5-3),
          //             decoration: BoxDecoration(
          //                 boxShadow: const [
          //                   BoxShadow(
          //                       offset: Offset(0, 1),
          ...
          //                 prefixIcon: Icon(
          //                   Icons.search,
          //                   color: Colors.grey,size: Dimesion.size24,
          //                 ),
          //                 hintText: 'Search....',
          ...
          SearchPageView(),
          Container(
              padding:  EdgeInsets.only(left: Dimesion.width30, top: Dimesion.height20),
              child: Text(
                    ...
                    GridView.builder(
                      ...
                      gridDelegate:
                          SliverGridDelegateWithFixedCrossAxisCount(
                              crossAxisCount: 2,
                              mainAxisExtent: Dimesion.height40*4.6,
                              mainAxisSpacing: 5,
                              crossAxisSpacing: 5),
                      itemCount: 4,
                      itemBuilder: (context, index) {
                        ...
                        //           children: [
                        //             Container(
                        //               // width: dimesion, // 45% of screen width
